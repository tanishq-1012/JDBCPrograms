...
public class InsertApp2 {
	...
	public static void main(String[] args) throws SQLException {
		//Establish the connection
				...
				String sqlInsertQuery = "insert into student(`sname`,`sage`,`saddress`)values("+sname+","+sage+","+address+")";
...
//Enter the address of the student :: CSK
//insert into student(`sname`,`sage`,`saddress`)values('Tanya',26,'CSK')
